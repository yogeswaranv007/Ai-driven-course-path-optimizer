...
const planService = {
   ...
   * 5. Call Groq AI to generate tasks, exercises, projects per week
  ...
  async generatePlan(user, { skills, hoursPerDay = null, jobRole = null }) {
    ...
    try {
      ...
      // STEP 4: Integrate Groq AI to generate tasks, exercises, projects
      ...
      // Call Groq to generate AI-enriched learning content
      ...
      try {
        ...
        console.warn(
          '⚠️ Groq AI generation failed, using fallback plan structure:',
          groqError.message
        );
      ...
      const explainability = [
        {
          ...
          reasons: [
            ...
            ...(aiEnrichedPlan
              ? [`✨ AI-powered learning tasks and exercises generated by Groq`]
      ...
      const plan = await learningPlanRepository.create({
        userId: user._id,
        planVersion: 4, // Job-role-based planning with Groq integration
        skillGaps,
        weeks: enrichedWeeks,
        explainability,
        isActive: true,
